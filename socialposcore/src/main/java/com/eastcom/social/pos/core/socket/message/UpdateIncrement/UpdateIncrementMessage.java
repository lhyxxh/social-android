package com.eastcom.social.pos.core.socket.message.UpdateIncrement;
...
public class UpdateIncrementMessage extends SoMessage {

    public UpdateIncrementMessage(String versionMain, String versionSub,
                             String packetNo) {
        ...
        try {
            ...
            this.command = SoCommand.安卓增量包更新;
    ...
    public UpdateIncrementMessage(int versionMain, int versionSub,
                             int packetNo) {
        short bodyLength = (short) (2 + 2 + 4);
