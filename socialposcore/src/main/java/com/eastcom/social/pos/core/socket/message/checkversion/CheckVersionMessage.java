...
public class CheckVersionMessage extends SoMessage {

	private int versionMain;

	private int versionSub;

	public CheckVersionMessage(int versionMain, int versionSub) {
		short bodyLength = 4;
		...
		this.command = SoCommand.校验安卓固件版本;
	...
	public CheckVersionMessage(SoMessage message) {
		super(message);
