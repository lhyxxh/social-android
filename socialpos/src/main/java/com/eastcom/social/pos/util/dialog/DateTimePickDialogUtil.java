...
public class DateTimePickDialogUtil implements OnDateChangedListener {
	 ...
	 */
	public DateTimePickDialogUtil(Activity activity, String initDateTime ,int hours) {
	...
	public AlertDialog dateTimePicKDialog(final TextView inputDate) {
		ScrollView dateTimeLayout = (ScrollView) activity.getLayoutInflater()
				.inflate(R.layout.view_common_datetime, null);
		...
		// ad.getWindow().setLayout(300, 300);
...
//	}
	...
	private Calendar getCalendarByInintData(String initDateTime) {
		...
		Date date = null;
		try {
			date = format.parse(initDateTime);
