...
public class SettingDialog extends Dialog {
	...
	public static class Builder implements android.view.View.OnClickListener {
		...
		public SettingDialog create() {
			...
			View layout = inflater.inflate(R.layout.view_setting_dialog, null);
		...
		@Override
		public void onClick(View v) {
			String et = et_sum.getText().toString();
			int len = et.length();
			switch (v.getId()) {
			case R.id.tv_1:
			...
			case R.id.tv_4:
				...
				break;
			case R.id.tv_5:
				oldString = oldString + "5";
				et_sum.setText(et + "*");
				break;
			case R.id.tv_6:
				oldString = oldString + "6";
				et_sum.setText(et + "*");
				break;
			case R.id.tv_7:
				oldString = oldString + "7";
				et_sum.setText(et + "*");
				break;
			case R.id.tv_8:
				oldString = oldString + "8";
				et_sum.setText(et + "*");
				break;
			case R.id.tv_9:
				oldString = oldString + "9";
				et_sum.setText(et + "*");
				break;
			case R.id.tv_0:
			...
			case R.id.tv_delete:
				if (len>0) {
					et_sum.setText(et.substring(0, len - 1));
					oldString = oldString.substring(0, len - 1);
				}
				break;
